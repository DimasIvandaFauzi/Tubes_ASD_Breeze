            ...
            <div className=" bg-white">
                <div className=" bg-white h-screen md:flex flex-row md:justify-around justify-center items-center">
                    <div className=" text-extra-bold md:w-2/5 mt-8 w-3/4">
                        ...
                        <div className="md:mt-5 text-lg">
                            <button className=" transition  ease-in-out hover:border-black border-2 hover:bg-gray-900 hover:text-white px-4 rounded-full font-semibold pb-1 border-black hover:border-2">
                ...
                <div className=" container flex flex-col items-center justify-center h-screen">
                    <div className=" mt-6 outline h-14 outline-black w-4/12 flex justify-around items-center">
                                <h1 className=" font-medium text-5xl font-serif ">Benefit</h1>  
                                <span className=" text-5xl font-serif">+</span>      
                    </div>
                    <div className=" mt-6 outline h-14 outline-black w-4/12 flex justify-around items-center">
                        <h1 className=" font-medium text-5xl font-serif">Kemudahan</h1>  
                        <span className=" text-5xl font-serif">+</span>      
                    </div>
                    <div className=""></div>
