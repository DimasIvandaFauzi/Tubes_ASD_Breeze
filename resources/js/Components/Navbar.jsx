                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="-me-2 flex items-center sm:hidden">
                        <button
                            ...
                            className=" bg-white-900 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-white-100 focus:outline-none focus:bg-white-100 focus:text-gray-500 transition duration-150 ease-in-out"
                        >
                            <svg
                                className="h-6 w-6"
                                stroke="currentColor"
